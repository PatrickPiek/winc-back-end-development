...
class CommandLineArgs():
    ...
    def __init__(self):
        ...
        cli.add_argument('action', type=str, action='store', metavar='action',
                         help='the action to perform (buy, sell, report)', nargs='?')

        cli.add_argument('report', type=str, action='store', metavar='report',
                         help='the report action to perform (revenue, profit, inventory)', nargs='?')
        ...
        cli.add_argument('--advance-time', type=int, action='store', metavar='',
